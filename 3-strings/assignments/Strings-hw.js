...
let template1 = `${word1} Jackson, did you ${word13} today? ${word17} saw some left over ${word9} in the fridge if you want some. Its my ${word15} pepperoni and bacon!`

console.log(template1)

// 4. Given the string of your full name get your initials.

const fullName = 'Donald Williams'

const x = fullName[0] + fullName[7]
console.log(x)
